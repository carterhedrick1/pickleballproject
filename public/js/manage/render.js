// The nodes the management page's lists are made of.
//
// Kept apart from the tab controllers because it is the only part of the page that can be
// tested without a browser: every function here takes a document and returns a node, touching
// no state and making no requests. test/manage-render.test.js drives it under plain Node
// with a tiny fake document.
//
// Nothing in here interpolates markup. Text goes in through textContent, which is what makes a
// player free to call themselves whatever they like without it becoming part of the page.
...
export { createPlayerItem, createRecipientOption, createRosterOption, createStatusChip, prettyPhone };
export default { createPlayerItem, createRecipientOption, createRosterOption, createStatusChip, prettyPhone };
